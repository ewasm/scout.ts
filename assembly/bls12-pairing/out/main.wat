(module
 ...
 (import "watimports" "$g1m_fromMontgomery" (func $websnark_bls12/bls12_g1m_fromMontgomery (param i32 i32)))
 (memory $0 8)
 ...
 (func $~lib/typedarray/Uint8Array.wrap (; 18 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  (local $1 i32)
 ...
 (func $~lib/rt/stub/__realloc (; 21 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  local.get $0
  i32.const 15
 ...
 (func $~lib/array/ensureSize (; 22 ;) (type $FUNCSIG$vi) (param $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  i32.const 0
 ...
 (func $~lib/array/Array.create<u8> (; 23 ;) (type $FUNCSIG$i) (result i32)
  (local $0 i32)
  i32.const 16
  i32.const 4
  call $~lib/rt/stub/__alloc
 ...
 (func $~lib/rt/__allocArray (; 24 ;) (type $FUNCSIG$i) (result i32)
  (local $0 i32)
  (local $1 i32)
  i32.const 16
  i32.const 4
 ...
 (func $main/main (; 26 ;) (type $FUNCSIG$i) (result i32)
  ...
  local.get $0
  local.get $0
  call $websnark_bls12/bls12_g1m_fromMontgomery
  local.get $0
  i32.const 16
  i32.add
